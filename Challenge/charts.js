...
// Deliverable 1
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      var sample_num = samples_array.filter(sampleID => sampleID.id == sample);
      //  5. Create a variable that holds the first sample in the array.
      var first_sample = sample_num[0];
...
// Deliverable 3
    ...
    var first_metadata = metadata_filtered[0];

    // 3. Create a variable that holds the washing frequency.
    var wfreq = first_metadata.wfreq;
    ...
    var gaugeData = [{  domain: {x: [0,1], y: [0,1]},
                        ...
                        gauge: {
                            axis: {range: [null, 10]},
                            steps: [{range: [0,2], color: "red"}, {range: [2,4], color: "orange"}, {range: [4,6], color: "yellow"},
                            {range: [6,8], color: "lightgreen"}, {range: [8,10], color: "green"}],
                            bar: {color: "black"}
